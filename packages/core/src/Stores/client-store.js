...
import { makeObservable, action, computed, observable, reaction, runInAction, toJS, when } from 'mobx';
...
export default class ClientStore extends BaseStore {
    ...
    constructor(root_store) {
        ...
        makeObservable(this, {
            ...
            // this will store the landing_company API response, including
            // financial_company: observable,
            // gaming_company: observable,
            // mt_financial_company: observable,
            // mt_gaming_company: observable,
