...
export const buildDurationConfig = (
    ...
    const start_type = durations.min_max[contract.start_type as keyof typeof durations.min_max];

    start_type[contract.expiry_type as keyof typeof duration_min_max] = {
